...
<!-- Meta Pixel Code -->
    ...
    <div class="wrapper">
        <div class="header-container mb-1">
            ...
            <div class="d-block">
                <img src="images/new/<?php if(@$params['utm_content'] != ''){echo $params['utm_content'].'.jpg';}else {echo 'PizzaPan.jpg';} ?>" alt="pizza maker" class="d-block  mx-auto img-fluid" loading="lazy">
            </div>
        </div>
        <div class="container">
